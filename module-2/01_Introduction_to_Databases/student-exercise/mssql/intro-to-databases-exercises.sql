...
SELECT name, population FROM city WHERE district = 'Ontario'; --ORDER BY population DESC;
...
-- 20. The name, continent, GNP, and average life expectancy of all countries that have an average life expectancy of at least 70 years and a GNP between $1 million and $100 million dollars (3 rows) Confused as to why I get 6
...
SELECT YEAR(GETDATE()) - indepyear as numberofyearsinceindepday FROM country WHERE indepyear IS NOT NULL;