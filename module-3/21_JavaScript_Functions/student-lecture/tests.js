...
describe("createSentenceFromUser", () => {
  ...
  it("should still print even when no quirks given", () => {
    createSentenceFromUser("No", 5).should.equal(
      "No is currently 5 years old. Their quirks are: "
    );
  });
});
...
describe("average", () => {
  it("should average all numbers passed to it", () => {
    average(1, 2, 3).should.deep.equal(2);
  });
});
